-- Relax RLS policies for development to allow public access (anon)
-- Units policies
...
CREATE POLICY "Public can delete units" ON public.units FOR DELETE USING (true);
...
CREATE POLICY "Public can delete tenants" ON public.tenants FOR DELETE USING (true);
...
CREATE POLICY "Public can update inventory" ON public.inventory FOR UPDATE USING (true);
...
CREATE POLICY "Public can insert utilities" ON public.utilities FOR INSERT WITH CHECK (true);
CREATE POLICY "Public can update utilities" ON public.utilities FOR UPDATE USING (true);
CREATE POLICY "Public can delete utilities" ON public.utilities FOR DELETE USING (true);

-- Maintenance policies
ALTER TABLE public.maintenance ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Public can read maintenance" ON public.maintenance FOR SELECT USING (true);
...
CREATE POLICY "Public can delete maintenance" ON public.maintenance FOR DELETE USING (true);
...
CREATE POLICY "Public can update users" ON public.users FOR UPDATE USING (true) WITH CHECK (true);
